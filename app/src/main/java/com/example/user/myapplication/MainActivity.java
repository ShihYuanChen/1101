...
public class MainActivity extends AppCompatActivity {
    ...
    protected SeekBar rabbit_seelBar,tortise_seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit_seelBar = (SeekBar) findViewById(R.id.rabbit_seekBar);
        tortise_seekBar = (SeekBar) findViewById(R.id.toroise_seekBar);
    ...
    private Handler mHandler = new Handler(){
        ...
        public  void handleMessage(Message msg){
            switch (msg.what){
                case 1:
                    rabbit_seelBar.setProgress(rabbit_count);
                    break;
            }
    ...
    private  void runAsyncTAsk(){
        new AsyncTask<Void, Integer, Boolean>(){
            ...
            protected void onProgressUpdate(Integer... values){
                ...
                tortise_seekBar.setProgress(values[0]);
            }
            @Override
